...
const Head = () => {
  ...
  // Redux state variable for cached search results and dispatch function
  ...
  // Effect hook to get search suggestion when search query state changes
  useEffect(() => {
    // Set a timer to delay search suggestion fetching
  ...
  // Data API and sets the searchresults state to the suggestions
  // It also caches the search results for the future use.
